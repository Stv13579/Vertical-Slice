...
public class DialogueScript : MonoBehaviour
{
    ...
    public void GatherDialogueBoxData()
    {
        ...
        dialogueData.nameFont = Resources.Load<TMP_FontAsset>("UIAssets/Roguedash-Line SDF");
        dialogueData.dialogueFont = Resources.Load<TMP_FontAsset>("UIAssets/Roguedash-Solid SDF");
