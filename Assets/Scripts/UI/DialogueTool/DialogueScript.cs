...
public class DialogueScript : MonoBehaviour
{
    ...
    public void CreateDialogueBox()
    {
        ...
        Image dialogueBox = Instantiate(DB, new Vector3(960,825,0), Quaternion.identity, dialogueUIHolder.transform);
    ...
    public void CreateNameText()
    {
        ...
        TextMeshProUGUI nameText = Instantiate(NT, new Vector3(410, 800, 0), Quaternion.Euler(0.0f, 0.0f, 10.0f), dialogueUIHolder.transform);
    ...
    public void CreateNextExitButton()
    {
        ...
        Button backButton = Instantiate(NEB, new Vector3(1550, 750, 0), Quaternion.identity, dialogueUIHolder.transform);
    ...
    public void CreatePlayerOption1Button()
    {
        ...
        Button backButton = Instantiate(NEB, new Vector3(960, 700, 0), Quaternion.identity, dialogueUIHolder.transform);
    ...
    {
        var NEB = dialogueData.dialogueOptionButton;
        Button backButton = Instantiate(NEB, new Vector3(960, 600, 0), Quaternion.identity, dialogueUIHolder.transform);
    ...
    {
        var NEB = dialogueData.dialogueOptionButton;
        Button backButton = Instantiate(NEB, new Vector3(960, 550, 0), Quaternion.identity, dialogueUIHolder.transform);
    ...
    {
        dialogueData.dialogueBox = Resources.Load<Image>("DialogueTool/DialogueBoxImage");
        dialogueData.nameText = Resources.Load<TextMeshProUGUI>("DialogueTool/NPCNameText(TMP)");
        dialogueData.dialogueText = Resources.Load<TextMeshProUGUI>("DialogueTool/DialogueText(TMP)");
        dialogueData.backButton = Resources.Load<Button>("DialogueTool/BackandExitButton(TMP)");
        dialogueData.nameFont = Resources.Load<TMP_FontAsset>("DialogueTool/Roguedash-Line SDF");
        dialogueData.dialogueFont = Resources.Load<TMP_FontAsset>("DialogueTool/Roguedash-Solid SDF");
        dialogueData.interactImage = Resources.Load<Image>("DialogueTool/InteractWithPlayer");
        dialogueData.dialogueOptionButton = Resources.Load<Button>("DialogueTool/PlayerOption(TMP)");
    }
}
