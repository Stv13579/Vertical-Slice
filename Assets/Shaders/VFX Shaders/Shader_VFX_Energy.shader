	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult10_g4 = (float2(_Width_Rec , _Hight_Rec));
				...
				float ElecticalCurrents118 = ( clampResult92 * saturate( min( break16_g4.x , break16_g4.y ) ) );
				...
				float3 objToWorld6 = mul( GetObjectToWorldMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float smoothstepResult15 = smoothstep( _SmoothStep_Fill , ( _SmoothStep_Fill + _Smoothstep_Fade ) , ( Voronoi40 + ( 1.0 - (0.0 + (objToWorld6.y - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ) ));
...
/*ASEBEGIN
Version=18935
112;73;1682;871;4969.229;1253.959;1.6;True;False
...
Node;AmplifyShaderEditor.WorldPosInputsNode;5;-4337.305,731.2277;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TransformPositionNode;6;-4161.47,723.2875;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FresnelNode;63;-3320.762,326.7353;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;91;-3558.646,1159.714;Inherit;False;Rectangle;-1;;4;6b23e0c975270fb4084c354b2c83366a;0;3;1;FLOAT2;0,0;False;2;FLOAT;0.5;False;3;FLOAT;0.5;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C0445F720B1EAA6B590C3C979B8FB13EF85F3F18