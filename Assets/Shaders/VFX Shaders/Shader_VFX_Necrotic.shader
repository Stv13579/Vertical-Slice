	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float3 objToWorld64 = mul( GetObjectToWorldMatrix(), float4( ase_worldPos, 1 ) ).xyz;
				float2 panner30 = ( _TimeParameters.x * float2( -0.4,-0.1 ) + objToWorld64.xy);
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 objToWorld64 = mul( GetObjectToWorldMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float2 panner30 = ( _TimeParameters.x * float2( -0.4,-0.1 ) + objToWorld64.xy);
				float simplePerlin3D7 = snoise( float3( panner30 ,  0.0 )*_Noise_1_Scale );
				simplePerlin3D7 = simplePerlin3D7*0.5 + 0.5;
				float Noise_169 = simplePerlin3D7;
				float2 panner22 = ( _TimeParameters.x * float2( 0.1,0.1 ) + objToWorld64.xy);
				...
				float temp_output_3_0_g7 = ( Noise_268 - Noise_169 );
				float temp_output_28_0 = ( (-0.2 + (Noise_169 - 0.0) * (1.0 - -0.2) / (1.0 - 0.0)) * saturate( ( temp_output_3_0_g7 / fwidth( temp_output_3_0_g7 ) ) ) );
				...
				float2 rotator59 = mul( objToWorld64.xy - float2( 0,0 ) , float2x2( cos59 , -sin59 , sin59 , cos59 )) + float2( 0,0 );
				...
				float3 objToWorld149 = mul( GetObjectToWorldMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float smoothstepResult167 = smoothstep( _SmoothStep_Fill , ( _SmoothStep_Fill + _Smoothstep_Fade ) , ( Noise_169 + ( 1.0 - (0.0 + (objToWorld149.y - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) ) ));
...
/*ASEBEGIN
Version=18935
-22;592.3334;1920;987;4233.466;1432.228;4.466156;True;False
...
Node;AmplifyShaderEditor.WorldPosInputsNode;65;-2118.995,-47.37688;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TransformPositionNode;64;-1954.296,-50.47037;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;12;-100.2995,131.5183;Inherit;False;Step Antialiasing;-1;;7;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.6;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TransformPositionNode;149;85.03656,1044.897;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;85;389.2328,363.05;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;110;530.1912,373.3418;Inherit;False;Outer_Section;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;11;-1796.962,-464.9402;Inherit;False;Property;_BaseColour;BaseColour;1;1;[HDR];Create;True;0;0;0;False;0;False;0,1,0.08572555,0;0.2196078,1.498039,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=60D62638C24574999982E91C89AAFB2456420CE8